...
//$( ".nametag" ).removeClass('whitetext');
 ...
 '<div class="popup infopopup" style="margin-top:44px;height:calc(100% - 127px);z-index:12000;background: -webkit-linear-gradient(top, rgba(255,255,255,0) 9%,rgba(255,255,255,0) 12%,rgba(255,255,255,0.22) 31%,rgba(255,255,255,0.37) 44%,rgba(255,255,255,0.6) 64%,rgba(255,255,255,1) 100%); /* Chrome10-25,Safari5.1-6 */" >'+
...
'<div class="swiper-container swiper-questions" style="overflow-y:scroll;height:100%;">'+
