...
'<div onclick="scrolltoTop()" style="z-index:5000;margin-top:-40px;background-color:white;border-radius:20px;border-bottom-right-radius:0px;border-bottom-left-radius:0px;display:none;position:absolute;" class="prof_'+i+' infoprofile availyo_'+ new_all[i].id+'">'+

'<h3 onclick="scrolltoTop()" class="adown arrowdown_'+new_all[i].id+' availyope availyo_'+ new_all[i].id+'" style="display:none;margin-top:0px;z-index:120000;right:0px;'+boxcolor+';font-size:14px;padding:0px;margin-left:10px;"><i class="pe-7f-angle-down pe-3x" style="float:left;margin-top:-15px;"></i>'+
          
'</h3>'+
   

     '<div class="content-block-title" style="padding-top:0px;clear:both;margin-top:-15px;">About '+new_all[i].name+'</div>'+
