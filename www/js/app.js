...
//$( ".nametag" ).removeClass('whitetext');
 ...
 '<div class="popup infopopup" style="margin-top:44px;height:calc(100% - 127px);z-index:12000;background: -webkit-linear-gradient(top, rgba(255,255,255,0) 90%,rgba(255,255,255,1) 100%); /* Chrome10-25,Safari5.1-6 */" >'+
