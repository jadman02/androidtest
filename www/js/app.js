...
var loginmethod = window.localStorage.getItem("loginmethod");
	...
	else{invitebutton = '<a class="button active external" href="sms:&body=Check out a new dating app in the App Store: https://fb.me/1554148374659639. Thoughts? ">Invite friends</a>';}
...
slidecontent = '<div class="age_'+random_all[i].age+' swiper-slide slide_'+random_all[i].id+'" style="text-align:center;padding-top:3px;padding-left:3px;"><span class="preloader default_'+randomid+'"></span><div style="width:'+slidewidth+'px;margin:0 auto;"><div style="position:absolute;right:2px;top:0px;" class="arrowdivhome_'+random_all[i].id+' maindivhome_'+randomid+'"></div><div class="distance_'+random_all[i].id+'" style="display:none;width:50px;background-color:#2196f3;color:white;z-index:999;padding:0.5px;position:absolute;left: 3px;z-index:1000;font-size:12px;"></div><img crossOrigin="Anonymous" id="photo_'+random_all[i].id+'" onload="mainLoaded(\''+random_all[i].id+'\',\''+randomid+'\');" class="swiper-lazy pp photo_'+random_all[i].id+' photo_'+randomid+'" data-src="'+random_all[i].profilepicstringsmall+'" style="'+imagestyle+'-webkit-filter:none;display:none;overflow:hidden;margin-top:0px;"/><div style="bottom:0px;right:0px;position:absolute;width:50px;overflow-x:hidden;height:50px;overflow-y:hidden;display:none;" class="icondiv iconpos_'+random_all[i].id+'"><img src="media/duckfaceonly.png" style="width:100px;"></div><p class="name_'+random_all[i].id+'" style="clear:both;font-weight:bold;margin-left:23px;margin-top:-30px;color:white;font-size:15px;text-align:left;"></p></div></div>';    

} 

else if (index3 > -1) {
slidecontent = '<div class="age_'+random_all[i].age+' swiper-slide slide_'+random_all[i].id+'" style="text-align:center;padding-top:3px;padding-left:3px;"><span class="preloader default_'+randomid+'"></span><div style="width:'+slidewidth+'px;margin:0 auto;"><div style="position:absolute;right:2px;top:0px;" class="arrowdivhome_'+random_all[i].id+' maindivhome_'+randomid+'"></div><div class="distance_'+random_all[i].id+'" style="display:none;width:50px;background-color:#ccc;color:white;z-index:999;padding:0.5px;position:absolute;left: 3px;z-index:1000;font-size:12px;"></div><img crossOrigin="Anonymous" id="photo_'+random_all[i].id+'" onload="mainLoaded(\''+random_all[i].id+'\',\''+randomid+'\');" class="swiper-lazy pp photo_'+random_all[i].id+' photo_'+randomid+'" data-src="'+random_all[i].profilepicstringsmall+'" style="'+imagestyle+'-webkit-filter:grayscale(80%);overflow:hidden;display:none;margin-top:0px;"/><div style="bottom:0px;right:0px;position:absolute;width:50px;overflow-x:hidden;height:50px;overflow-y:hidden;-webkit-filter:grayscale(1%);display:none;" class="icondiv iconpos_'+random_all[i].id+'"><img src="media/duckfaceonly.png" style="width:100px;"></div><p class="name_'+random_all[i].id+'" style="-webkit-filter:grayscale(80%);clear:both;font-weight:bold;margin-left:23px;margin-top:-30px;color:white;font-size:15px;text-align:left;"></p></div></div>';           
} 


else if (index4 > -1) {
slidecontent = '<div class="age_'+random_all[i].age+' swiper-slide slide_'+random_all[i].id+'" style="text-align:center;padding-top:3px;padding-left:3px;"><span class="preloader default_'+randomid+'"></span><div style="width:'+slidewidth+'px;margin:0 auto;"><div style="position:absolute;right:2px;top:0px;" class="arrowdivhome_'+random_all[i].id+' maindivhome_'+randomid+'"></div><div class="distance_'+random_all[i].id+'" style="display:none;width:50px;background-color:#ccc;color:white;z-index:999;padding:0.5px;position:absolute;left: 3px;z-index:1000;font-size:12px;"></div><img crossOrigin="Anonymous" id="photo_'+random_all[i].id+'" onload="mainLoaded(\''+random_all[i].id+'\',\''+randomid+'\');" class="swiper-lazy pp photo_'+random_all[i].id+' photo_'+randomid+'" data-src="'+random_all[i].profilepicstringsmall+'" style="'+imagestyle+'-webkit-filter:grayscale(80%);overflow:hidden;display:none;margin-top:0px;"/><div style="bottom:0px;right:0px;position:absolute;width:50px;overflow-x:hidden;height:50px;overflow-y:hidden;-webkit-filter:grayscale(1%);display:none;" class="icondiv iconpos_'+random_all[i].id+'"><img src="media/datefaceonly.png" style="width:100px;"></div><p class="name_'+random_all[i].id+'" style="-webkit-filter:grayscale(80%);clear:both;font-weight:bold;margin-left:23px;margin-top:-30px;color:white;font-size:15px;text-align:left;"></p></div></div>';           
} 



			
else {slidecontent = '<div class="age_'+random_all[i].age+' swiper-slide slide_'+random_all[i].id+'" style="text-align:center;padding-top:3px;padding-left:3px;"><span class="preloader default_'+randomid+'"></span><div style="width:'+slidewidth+'px;margin:0 auto;"><div style="position:absolute;right:2px;top:0px;" class="arrowdivhome_'+random_all[i].id+' maindivhome_'+randomid+'"></div><div class="distance_'+random_all[i].id+'" style="display:none;width:50px;background-color:#ccc;color:white;z-index:999;padding:0.5px;position:absolute;left: 3px;z-index:1000;font-size:12px;"></div><img crossOrigin="Anonymous" id="photo_'+random_all[i].id+'" onload="mainLoaded(\''+random_all[i].id+'\',\''+randomid+'\');" class="swiper-lazy pp photo_'+random_all[i].id+' photo_'+randomid+'" data-src="'+random_all[i].profilepicstringsmall+'" style="'+imagestyle+'-webkit-filter:grayscale(80%);overflow:hidden;display:none;margin-top:0px;"><div style="bottom:0px;right:0px;position:absolute;width:50px;overflow-x:hidden;height:50px;overflow-y:hidden;display:none;" class="icondiv iconpos_'+random_all[i].id+'"></div><p class="name_'+random_all[i].id+'" style="-webkit-filter:grayscale(80%);clear:both;font-weight:bold;margin-top:-30px;color:white;font-size:15px;text-align:left;float:left;margin-left:23px;"></p></div></div>'; 
     }
...
slidecontent = '<div class="age_'+subtract+' swiper-slide slide_'+graphid+'" style="text-align:center;padding-top:3px;padding-left:3px;"><span class="preloader default_'+randomid+'"></span><div style="width:'+slidewidth+'px;margin:0 auto;"><div style="position:absolute;right:2px;top:0px;" class="arrowdivhome_'+graphid+' maindivhome_'+randomid+'"></div><div class="distance_'+graphid+'" style="display:none;width:50px;background-color:#2196f3;color:white;z-index:999;padding:0.5px;position:absolute;left: 3px;z-index:1000;font-size:12px;">'+distancestring+'</div><img crossOrigin="Anonymous" id="photo_'+graphid+'" onload="mainLoaded(\''+graphid+'\',\''+randomid+'\');" class="swiper-lazy pp photo_'+graphid+' photo_'+randomid+'" data-src="'+profilepicstringsmall+'" style="'+imagestyle+'-webkit-filter:none;display:none;overflow:hidden;margin-top:0px;"/><div style="bottom:0px;right:0px;position:absolute;width:50px;overflow-x:hidden;height:50px;overflow-y:hidden;display:none;" class="icondiv iconpos_'+graphid+'"><img src="media/duckfaceonly.png" style="width:100px;"></div>'+activecircle+'<p class="name_'+graphid+'" style="clear:both;font-weight:bold;margin-left:23px;margin-top:-30px;color:white;font-size:15px;text-align:left;"></p></div></div>';    
...
slidecontent = '<div class="age_'+subtract+' swiper-slide slide_'+graphid+'" style="text-align:center;padding-top:3px;padding-left:3px;"><span class="preloader default_'+randomid+'"></span><div style="width:'+slidewidth+'px;margin:0 auto;"><div style="position:absolute;right:2px;top:0px;" class="arrowdivhome_'+graphid+' maindivhome_'+randomid+'"></div><div class="distance_'+graphid+'" style="display:none;width:50px;background-color:#ccc;color:white;z-index:999;padding:0.5px;position:absolute;left: 3px;z-index:1000;font-size:12px;">'+distancestring+'</div><img crossOrigin="Anonymous" id="photo_'+graphid+'" onload="mainLoaded(\''+graphid+'\',\''+randomid+'\');" class="swiper-lazy pp photo_'+graphid+' photo_'+randomid+'" data-src="'+profilepicstringsmall+'" style="'+imagestyle+'-webkit-filter:grayscale(80%);overflow:hidden;display:none;margin-top:0px;"/><div style="bottom:0px;right:0px;position:absolute;width:50px;overflow-x:hidden;height:50px;overflow-y:hidden;-webkit-filter:grayscale(1%);display:none;" class="icondiv iconpos_'+graphid+'"><img src="media/duckfaceonly.png" style="width:100px;"></div>'+activecircle+'<p class="name_'+graphid+'" style="-webkit-filter:grayscale(80%);clear:both;font-weight:bold;margin-left:23px;margin-top:-30px;color:white;font-size:15px;text-align:left;"></p></div></div>';           
} 


else if (index4 > -1) {
slidecontent = '<div class="age_'+subtract+' swiper-slide slide_'+graphid+'" style="text-align:center;padding-top:3px;padding-left:3px;"><span class="preloader default_'+randomid+'"></span><div style="width:'+slidewidth+'px;margin:0 auto;"><div style="position:absolute;right:2px;top:0px;" class="arrowdivhome_'+graphid+' maindivhome_'+randomid+'"></div><div class="distance_'+graphid+'" style="display:none;width:50px;background-color:#ccc;color:white;z-index:999;padding:0.5px;position:absolute;left: 3px;z-index:1000;font-size:12px;">'+distancestring+'</div><img crossOrigin="Anonymous" id="photo_'+graphid+'" onload="mainLoaded(\''+graphid+'\',\''+randomid+'\');" class="swiper-lazy pp photo_'+graphid+' photo_'+randomid+'" data-src="'+profilepicstringsmall+'" style="'+imagestyle+'-webkit-filter:grayscale(80%);overflow:hidden;display:none;margin-top:0px;"/><div style="bottom:0px;right:0px;position:absolute;width:50px;overflow-x:hidden;height:50px;overflow-y:hidden;-webkit-filter:grayscale(1%);display:none;" class="icondiv iconpos_'+graphid+'"><img src="media/datefaceonly.png" style="width:100px;"></div>'+activecircle+'<p class="name_'+graphid+'" style="-webkit-filter:grayscale(80%);clear:both;font-weight:bold;margin-left:23px;margin-top:-30px;color:white;font-size:15px;text-align:left;"></p></div></div>';      
} 


else {
slidecontent = '<div class="age_'+subtract+' swiper-slide slide_'+graphid+'" style="text-align:center;padding-top:3px;padding-left:3px;"><span class="preloader default_'+randomid+'"></span><div style="width:'+slidewidth+'px;margin:0 auto;"><div style="position:absolute;right:2px;top:0px;" class="arrowdivhome_'+graphid+' maindivhome_'+randomid+'"></div><div class="distance_'+graphid+'" style="display:none;width:50px;background-color:#ccc;color:white;z-index:999;padding:0.5px;position:absolute;left: 3px;z-index:1000;font-size:12px;">'+distancestring+'</div><img crossOrigin="Anonymous" id="photo_'+graphid+'" onload="mainLoaded(\''+graphid+'\',\''+randomid+'\');" class="swiper-lazy pp photo_'+graphid+' photo_'+randomid+'" data-src="'+profilepicstringsmall+'" style="'+imagestyle+'-webkit-filter:grayscale(80%);overflow:hidden;display:none;margin-top:0px;"><div style="bottom:0px;right:0px;position:absolute;width:50px;overflow-x:hidden;height:50px;overflow-y:hidden;display:none;" class="icondiv iconpos_'+graphid+'"></div>'+activecircle+'<p class="name_'+graphid+'" style="-webkit-filter:grayscale(80%);clear:both;font-weight:bold;margin-top:-30px;color:white;font-size:15px;text-align:left;float:left;margin-left:23px;"></p></div></div>';    
...
firebase.auth().currentUser.getToken().then(function(idToken) {   
$.post( "http://www.dateorduck.com/updatelocation.php", { system:'android',projectid:f_projectid,token:idToken,currentid:firebase.auth().currentUser.uid,uid:f_uid,latitude:latitudep,longitude:longitudep} )
...
'<div onclick="scrolltoTop()" style="z-index:5000;margin-top:-42px;background-color:white;border-radius:20px;border-bottom-right-radius:0px;border-bottom-left-radius:0px;display:none;position:absolute;" class="prof_'+i+' infoprofile availyo_'+ new_all[i].id+'">'+

'<h3 onclick="scrolltoTop()" class="adown arrowdown_'+new_all[i].id+' availyope availyo_'+ new_all[i].id+'" style="display:none;margin-top:0px;z-index:120000;right:0px;'+boxcolor+';font-size:14px;padding:0px;margin-left:10px;"><i class="pe-7f-angle-down pe-3x" style="float:left;margin-top:-17px;"></i>'+
          
'</h3>'+
   

     '<div class="content-block-title" style="padding-top:0px;clear:both;margin-top:-17px;">About '+new_all[i].name+'</div>'+
...
myList.clearCache();
   ...
   function dateConfirmationPage(details){
	   ...
	   canloadchat = false;
          var g = new Date((d_chat_expire*1000)- 86400);
